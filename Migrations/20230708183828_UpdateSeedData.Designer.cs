...
namespace DMApp.Migrations
{
    ...
    [Migration("20230708183828_UpdateSeedData")]
            ...
            modelBuilder.Entity("DMApp.Models.Character", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6950),
                            CurrentHitPoints = 10,
                            Deception = 0,
                            Dexterity = 10,
                            ...
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6950),
                            Weight = "",
                            Wisdom = 10,
                            WisdomSavingThrow = 0
                        },
                        new
                        {
                            ...
                            Constitution = 10,
                            ConstitutionSavingThrow = 0,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6960),
                            CurrentHitPoints = 10,
                            Deception = 0,
                            Dexterity = 10,
                            DexteritySavingThrow = 0,
                            ...
                            Survival = 0,
                            TemporaryHitPoints = 0,
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6960),
                            Weight = "",
                            Wisdom = 10,
                            WisdomSavingThrow = 0
                        });
            ...
            modelBuilder.Entity("DMApp.Models.CharacterClass", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CharacterClassId = 1,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6200),
                            Description = "A fierce warrior of primitive background who taps into their rage to unleash devastating attacks.",
                            Name = "Barbarian",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6210)
                        },
                        new
                        {
                            CharacterClassId = 2,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6210),
                        ...
                        {
                            CharacterClassId = 6,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6220),
                            Description = "A disciplined warrior who has honed their body into a deadly weapon and gained mastery over ki.",
                            Name = "Monk",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6220)
                        },
                        new
                        {
                            CharacterClassId = 7,
                        ...
                        {
                            CharacterClassId = 11,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6230),
                            Description = "A spellcaster who makes a pact with a powerful entity, gaining magical abilities in exchange for service.",
                            Name = "Warlock",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6230)
                        },
                        new
                        {
                            CharacterClassId = 12,
            ...
            modelBuilder.Entity("DMApp.Models.CharacterRace", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CharacterRaceId = 1,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6510),
                            Description = "A humanoid creature with draconic ancestry, possessing dragon-like features and abilities.",
                            Name = "Dragonborn",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6510)
                        },
                        new
                        {
                            CharacterRaceId = 2,
                        ...
                        new
                        {
                            ...
                            Name = "Elf",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6520)
                        },
                        new
                        {
                            CharacterRaceId = 4,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6520),
                        ...
                        {
                            CharacterRaceId = 8,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6530),
                            Description = "A versatile and adaptable humanoid race, known for their ambition, diversity, and capacity for greatness.",
                            Name = "Human",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6530)
                        },
                        new
                        {
                            CharacterRaceId = 9,
            ...
            modelBuilder.Entity("DMApp.Models.DiscordGuild", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6560),
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6560)
                        });
                });
            ...
            modelBuilder.Entity("DMApp.Models.Feature", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FeatureId = 1,
                            ClassId = 1,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6680),
                            Description = "In battle, you fight with primal ferocity. On your turn, you can enter a rage as a bonus action.",
                            Name = "Rage",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6680)
                        },
                        new
                        {
                            FeatureId = 2,
                        ...
                        new
                        {
                            FeatureId = 3,
                            ClassId = 2,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6690),
                            ...
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6690)
                        },
                        new
                        {
                            FeatureId = 4,
                        ...
                        new
                        {
                            ...
                            Name = "Spellcasting",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6700)
                        },
                        new
                        {
                            FeatureId = 9,
                            ClassId = 5,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6700),
                        ...
                        new
                        {
                            FeatureId = 14,
                            ClassId = 7,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6710),
                            ...
                            Name = "Lay on Hands",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6710)
                        },
                        new
                        {
                            FeatureId = 15,
                        ...
                        new
                        {
                            FeatureId = 19,
                            ClassId = 10,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6720),
                            Description = "Choose a sorcerous origin, which describes the source of your innate magical power.",
                            Name = "Sorcerous Origin",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6720)
                        },
                        new
                        {
                            FeatureId = 20,
                        ...
                        new
                        {
                            FeatureId = 24,
                            ClassId = 12,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6730),
                            Description = "You have learned to regain some of your magical energy by studying your spellbook.",
                            Name = "Arcane Recovery",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6730)
                        });
                });
            ...
            modelBuilder.Entity("DMApp.Models.GuildCharacter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GuildId = 1077311704985239684L,
                            CharacterId = 1,
                            JoinedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(7020)
                        },
                        new
                        {
                            GuildId = 1077311704985239684L,
            ...
            modelBuilder.Entity("DMApp.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            Cost = 75,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6870),
                            Description = "It aint good, but it aint bad either",
                            Name = "Chain mail",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6870)
                        },
                        new
                        {
                            ItemId = 2,
            ...
            modelBuilder.Entity("DMApp.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrganizationId = 1,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6650),
                            ...
                            Name = "Harper's Guild",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6650)
                        },
                        new
                        {
                            OrganizationId = 2,
                        ...
                        {
                            OrganizationId = 6,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6660),
                            ...
                            Name = "Harpers",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6660)
                        },
                        new
                        {
                            OrganizationId = 7,
            ...
            modelBuilder.Entity("DMApp.Models.Spell", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SpellId = 1,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6890),
                            Description = "",
                            Name = "Spell 1",
                            SpellLevel = 0,
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6890)
                        },
                        new
                        {
                            SpellId = 2,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6900),
                            Description = "",
                            Name = "Spell 2",
                            SpellLevel = 0,
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6900)
                        });
                });
            ...
            modelBuilder.Entity("DMApp.Models.Trait", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TraitId = 1,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6760),
                            Description = "You have draconic ancestry. Choose one type of dragon from the Draconic Ancestry table.",
                            Name = "Draconic Ancestry",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6760)
                        },
                        new
                        {
                            TraitId = 2,
                        ...
                        new
                        {
                            ...
                            Name = "Fey Ancestry",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6770)
                        },
                        new
                        {
                            TraitId = 6,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6770),
                        ...
                        {
                            TraitId = 10,
                            CreatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6840),
                            Description = "You have advantage on saving throws against being frightened.",
                            Name = "Brave",
                            UpdatedOn = new DateTime(2023, 7, 8, 18, 38, 27, 921, DateTimeKind.Utc).AddTicks(6840)
                        },
                        new
                        {
                            TraitId = 11,
